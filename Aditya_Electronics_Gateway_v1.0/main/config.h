 ...
 *
 * Defaults to GPIO16 — the BOOT button already present on almost
...
#define FACTORY_RESET_GPIO       16
//  #define FACTORY_RESET_GPIO       32
 ...
 * redo the Step-1 IP configuration every time. Uses GPIO17 (was
 * RELAY1_GPIO, confirmed unused - see above). */
#define WIFI_ONLY_RESET_GPIO     17
// #define WIFI_ONLY_RESET_GPIO     33
#define WIFI_ONLY_RESET_HOLD_MS  10000u   /* tune anywhere in 5000-10000 */
...
#define LED_UPDATE_MS              0u    /* event-driven in telemetry task */    /* API 2: LED status write interval        */
#define RELAY_UPDATE_MS            0u    /* event-driven from NUC feedback */    /* API 3: relay status write interval      */
#define LED_ALL_MS             15000u    /* full LED heartbeat */    /* API 2: LED_CNT=ALL heartbeat interval   */
#define LOCK_POLL_MS             500u    /* API 8: lock status poll interval        */
#define RESET_POLL_MS            5000u    /* API 9: soft reset poll interval         */
#define LED_READ_POLL_MS         10000u    /* diagnostic read disabled */    /* API 11: LED status read-back interval   */
#define POWER_DETAILS_MS       1000u    /* heartbeat; changes are event-driven */    /* API 6A: power/battery details interval  */
#define INPUT_STATUS_POLL_MS       0u    /* API 10: consolidated relay/lock/softreset
...
#define ENABLE_SOFT_RESET_FEATURE   1
...
#define BATTERY_CUTOFF_MV        2700u
...
#define RELAY_POLL_PRIO         12
#define RELAY_REPORT_PRIO        9
#define TELEMETRY_TASK_PRIO       7
#define TELEMETRY_POLL_MS         25u
#define LED_BLINK_DETECT_MS      500u
#define LED_BLINK_CLEAR_MS      1000u